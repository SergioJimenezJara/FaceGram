...
public class UploadServlet extends HttpServlet {
    ...
    private static final String SUCCESS = "publicaciones";
    ...
    private static final String ACCESS_TOKEN = "cN9oYLEd0GAAAAAAAAAAnIo_NIXkgo6xATx3H080kEhx9vSNgGY1xQT-nd2ZMDUq";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            ...
            getServletContext().getRequestDispatcher("publicaciones").forward(request, response);
        }
    }
}
